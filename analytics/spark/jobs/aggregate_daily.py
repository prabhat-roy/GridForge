...
spark = SparkSession.builder.appName("gridforge-aggregate-daily").getOrCreate()
df = spark.read.format("iceberg").load("gridforge_mart.events_raw")
...
result.writeTo("gridforge_mart.fct_daily_metrics").using("iceberg").overwritePartitions()
