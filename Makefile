# GridForge â€” top-level Makefile
...
help:
	@echo "GridForge â€” common targets"
	@echo ""
...
tools-deploy:  ## Deploy every OSS tool registered for GridForge via ArgoCD
	kubectl apply -f gitops/argocd/applicationsets/all-tools-applicationset.yaml
	argocd appset get gridforge-tools --grpc-web

tools-status:  ## Show sync status of every registered tool
	argocd app list -l "project=gridforge-tools" --grpc-web
