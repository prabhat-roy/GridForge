...
Domain: ``grid-ops`` Â· Language: C++ Â· Port: 50040 (HTTP), 102 (IEC 61850), 502 (Modbus), 20000 (DNP3)
...
- DNP3 (TCP/20000) â€” RTU/IED communication
- IEC 61850 MMS (TCP/102) â€” substation automation
- Modbus TCP (TCP/502) â€” legacy meter / RTU integration

## See also

- [proto/grid-ops/scada-gateway.proto](../../../proto/grid-ops/scada-gateway.proto)
- [helm/charts/scada-gateway/](../../../helm/charts/scada-gateway/)
- [ot/](../../../ot/) â€” on-prem OT cluster overlay
